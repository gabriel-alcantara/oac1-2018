...
//altfp_sqrt CBX_AUTO_BLACKBOX="ALL" DEVICE_FAMILY="Cyclone V" PIPELINE=16 ROUNDING="TO_NEAREST" WIDTH_EXP=8 WIDTH_MAN=23 clock data nan overflow result zero
...
module  sqrt_s_alt_sqrt_block_ocb
	( 
	aclr,
	clken,
	clock,
...
endmodule //sqrt_s_alt_sqrt_block_ocb

//synthesis_resources = lpm_add_sub 27 reg 764 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  sqrt_s_altfp_sqrt_i9e
	( 
	clock,
	data,
	nan,
	...
	sqrt_s_alt_sqrt_block_ocb   alt_sqrt_block2
	( 
	.aclr(aclr),
	.clken(clk_en),
	.clock(clock),
	...
	assign
		...
		zero = zero_ff;
endmodule //sqrt_s_altfp_sqrt_i9e
//VALID FILE
...
module sqrt_s (
	...
	sqrt_s_altfp_sqrt_i9e	sqrt_s_altfp_sqrt_i9e_component (
				.clock (clock),
				.data (data),
				.nan (sub_wire0),
				.overflow (sub_wire1),
...
// Retrieval info: GEN_FILE: TYPE_NORMAL sqrt_s_bb.v FALSE
