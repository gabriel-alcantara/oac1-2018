...
module  cvt_s_w_altbarrel_shift_fof
	( 
	aclr,
	clk_en,
	clock,
...
endmodule //cvt_s_w_altbarrel_shift_fof
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  cvt_s_w_altfp_convert_7qm
	( 
	clock,
	dataa,
	result) ;
	...
	cvt_s_w_altbarrel_shift_fof   altbarrel_shift5
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
...
endmodule //cvt_s_w_altfp_convert_7qm
//VALID FILE
...
module cvt_s_w (
	...
	cvt_s_w_altfp_convert_7qm	cvt_s_w_altfp_convert_7qm_component (
				.clock (clock),
				.dataa (dataa),
				.result (sub_wire0));
...
// Retrieval info: GEN_FILE: TYPE_NORMAL cvt_s_w_bb.v FALSE TRUE
