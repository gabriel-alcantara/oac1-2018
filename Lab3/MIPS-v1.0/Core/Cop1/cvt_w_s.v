...
//altfp_convert CBX_AUTO_BLACKBOX="ALL" DEVICE_FAMILY="Cyclone V" OPERATION="FLOAT2INT" ROUNDING="TO_NEAREST" WIDTH_DATA=32 WIDTH_EXP_INPUT=8 WIDTH_EXP_OUTPUT=8 WIDTH_INT=32 WIDTH_MAN_INPUT=23 WIDTH_MAN_OUTPUT=23 WIDTH_RESULT=32 clock dataa nan overflow result underflow
...
module  cvt_w_s_altbarrel_shift_kof
	( 
	aclr,
	clk_en,
	clock,
...
endmodule //cvt_w_s_altbarrel_shift_kof

//synthesis_resources = lpm_add_sub 5 lpm_compare 4 reg 284 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  cvt_w_s_altfp_convert_e1p
	( 
	clock,
	dataa,
	nan,
...
endmodule //cvt_w_s_altfp_convert_e1p
//VALID FILE
...
module cvt_w_s (
	...
	cvt_w_s_altfp_convert_e1p	cvt_w_s_altfp_convert_e1p_component (
				.clock (clock),
				.dataa (dataa),
				.nan (sub_wire0),
				.overflow (sub_wire1),
...
// Retrieval info: GEN_FILE: TYPE_NORMAL cvt_w_s_bb.v FALSE TRUE
